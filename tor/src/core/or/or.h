...
/*MR-START*/
/* Define custom relay commands for the FFS-ZKP interactive handshake */
#define RELAY_COMMAND_ZKP_INIT       60
#define RELAY_COMMAND_ZKP_CHALLENGE  61
#define RELAY_COMMAND_ZKP_RESPONSE   62

#define RELAY_COMMAND_ZKP_FRAG_START 63
#define RELAY_COMMAND_ZKP_FRAG_CONT  64
#define RELAY_COMMAND_ZKP_FRAG_END   65

/* Define the size of our cryptographic variables (header: 2*(4*128)=1024 bytes) */
#define ZKP_VAR_SIZE 128
#define K_SECRETS 4

/* Structure representing the custom data packet header for Algorithm 1 */
typedef struct zkp_packet_header_t {
  uint8_t v_t[ZKP_VAR_SIZE]; 
  uint8_t S_i[ZKP_VAR_SIZE]; 
} zkp_packet_header_t;
/*MR-END*/
